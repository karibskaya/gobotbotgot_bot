...
briefs = {
    ...
    "Бот под ключ": [
        ...
        "Какую пользу аудитории принесет бот?\n\nКлиенты не будут пользоваться ботом, если он не приносит пользы. Сформулируйте выгоды, которые бот даст пользователям. Бесполезный бот — пустое вложение денег.\n\nНапример: <i>он позволит клиентам получать ответы на их вопросы в любое время. Он сократит время ожидания ответа. Сможет помочь клиенту с выбором товара прямо на сайте магазина</i>",
