...
briefs = {
    ...
    "Бот под ключ": [
        "Продукты и услуги компании\n\nЧтобы глубже понять вашу задачу, расскажите чем вы занимаетесь. Например: _Продаем электротехнику. Точки продажи по все России. Есть свой интернет-магазин: example.ru_"
