...
briefs = {
    ...
    "Бот для ленивых": [
        "Что должен делать бот?\n\n(например: выдавать материалы, собирать заявки, фильтровать клиентов, выдавать ссылку на оплату, вести по FAQ и т.д.)",
        "В каком мессенджере вы хотите использовать бота? (Instagram, Telegram, WhatsApp и т.д.)",
        "Для какого проекта он нужен?",
        "Какая цель у бота?\n\n(повысить продажи, сэкономить время, создать вау-эффект, просто удобно общаться с аудиторией)",
        "Какие поля/кнопки должны быть в нём?",
        "Есть ли у вас тексты/контент для бота? (если нет — помогу сформулировать)"
        "Есть ли у вас аккаунт на платформе (например, SalesBot, PuzzleBot, SMMBot)?"
        "Пример бота, который вам нравится (если есть):"
    ],
    "Бот под ключ": [
        "Продукты и услуги компании\n\nЧтобы глубже понять вашу задачу, расскажите чем вы занимаетесь. Например: <i>Продаем электротехнику. Точки продажи по все России. Есть свой интернет-магазин: example.ru</i>"
